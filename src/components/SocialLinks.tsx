const links = [
  {
    href: "https://github.com/JoshElieson",
    label: "GitHub",
    icon: (
  ...
  {
    href: "https://www.linkedin.com/in/josh-elieson/",
    label: "LinkedIn",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export function SocialLinks() {
  return (
    <nav
      ...
      className="fixed bottom-5 left-5 z-50 flex items-center gap-5 sm:bottom-6 sm:left-6"
    >
      {links.map(({ href, label, icon }) => (
        <a
          ...
          aria-label={label}
          className="text-muted transition-colors hover:text-foreground [&_svg]:h-6 [&_svg]:w-6"
        >
          {icon}
        </a>
      ))}
