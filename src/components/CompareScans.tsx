  ...
  return (
    <section className={shellClass}>
      ...
      <div className="flex flex-1 flex-col gap-5 p-6 sm:p-8">
        ...
        <div className="rounded-xl border border-dashed border-white/15 bg-surface-elevated/40 px-4 py-6 text-center">
          ...
          <ul className="mx-auto mt-4 grid max-w-md gap-2 text-left text-xs text-muted sm:grid-cols-2">
            <li className="flex items-center gap-2 rounded-lg border border-white/5 bg-navy/40 px-3 py-2">
...
function ScanSlot({
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-surface-elevated/60 p-4">
      ...
      <button
        type="button"
        disabled
        className="mt-3 flex w-full cursor-not-allowed items-center justify-between gap-2 rounded-lg border border-white/10 bg-navy/50 px-3 py-3 text-left text-sm text-muted opacity-70"
      >
